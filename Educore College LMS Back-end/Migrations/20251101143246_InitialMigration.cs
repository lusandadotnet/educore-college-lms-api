        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LecturerNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTasks", x => new { x.StudentId, x.TaskItemId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentTasks_Tasks_TaskItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lecturers_LecturerNumber",
                table: "Lecturers",
                column: "LecturerNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTasks_TaskItemId",
                table: "StudentTasks",
                column: "TaskItemId");
